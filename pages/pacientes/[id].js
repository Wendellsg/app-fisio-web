...
export default function PacientePage(){
    ...
    return(
        <div className={styles.PacienteContainer}>
            <div>
                <h2>Paciente</h2>
                <div style={width && width<=750?{display: 'none'}:{}} className={styles.PacienteName}><h1>Juliana Queiroz</h1><span>#325177</span></div>
            ...
            <div className={styles.PacienteContent}>
                ...
                <div className={styles.PacienteSideColumn}>
                    ...
                    <div className={styles.PacienteName} style={width && width>750?{display: 'none'}:{}}><h1>Juliana Queiroz</h1><span>#325177</span></div>
                    ...
                    <details className={styles.PacienteLastActivits}>
                        <summary>Ultimas Atividades</summary>
